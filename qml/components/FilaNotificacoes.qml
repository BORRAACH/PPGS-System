...
Item {
    ...
    Column {
        ...
        add: Transition {
            ...
            NumberAnimation { property: "y"; from: colunaToasts.height + 20; duration: 250; easing.type: Easing.OutCubic }
        }
        ...
        Repeater {
            ...
            delegate: Rectangle {
                ...
                color: model.sucesso ? Estilo.confirmar.normal : Estilo.cancelar.normal
